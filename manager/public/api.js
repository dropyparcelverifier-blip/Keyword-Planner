...
export const api = {
  ...
  jobUpdate:           (jobId, patch)  => _fetch('/api/jobs/update',    { method: 'POST', body: { jobId, ...patch } }),
  ...
  shopifyUpdateProduct:(productId, patch, opts = {}) => _fetch('/api/shopify/update-product', { method: 'POST', body: { confirm: 'PUSH', productId, patch, force: !!opts.force, validationContext: opts.validationContext || undefined, sku: opts.sku || null, productUrl: opts.productUrl || null, batchId: opts.batchId || null, currentTags: opts.currentTags || null, currentVendor: opts.currentVendor || null } }),
  ...
  jobsRequeueLowYield: (batchId, minRows) => _fetch('/api/jobs/requeue-low-yield', { method: 'POST', body: { batchId, minRows: minRows || 30 } }),
